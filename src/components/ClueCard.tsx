...
const ClueCard: React.FC<ClueCardProps> = ({ type, content, revealed, points, onClick, countryCode }) => {
  ...
  const handleImageClick = (e: React.MouseEvent) => {
    e.stopPropagation();
    if (revealed && (type === 'flag' || type === 'map')) {
      setIsZoomed(true);
    }
  };
  ...
  return (
    <>
      ...
      >
        <button
          onClick={revealed && (type === 'flag' || type === 'map') ? handleImageClick : onClick}
